...
function AssetsTable() {
  ...
  const filterAssets = (searchInput) => {
    if (searchInput === "") {
      setSearch(null);
    } else {
  ...
  return (
    <AssetTableWrapper>
      <Input
        placeholder="Filter asssets"
        size="large"
        allowClear
        onChange={(event) => filterAssets(event.target.value)}
