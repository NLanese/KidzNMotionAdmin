...
function Avatar({
  ...
  const renderFacialHair = () => {
    if (facialHairType === "facialHair1") {
      return (
        <path
          ...
          fill={facialHairColors[facialHairColor]}
        />
      );
    } else if (facialHairType === "facialHair2") {
      return (
        <path
    ...
    } else if (facialHairType === "facialHair3") {
      return (
        <path
    ...
    } else if (facialHairType === "facialHair4") {
      return (
        <path
    ...
    } else if (facialHairType === "facialHair5") {
      return (
        <path
  ...
  const renderHair = () => {
    ...
    } else if (hairType === "hair11") {
      return (
        <>
          <g transform="translate(18 8)">
            <cicle cx={14} cy={6} r={4} fill="#5a45ff" />
            <g fill={hairColors[hairColor]}>
              <path
